  ...
  return(
    <div className="login">
      <div className="holder">
        <h1 className="text-white head-01">{ page ? 'Sign In' : 'Register'}</h1>
        <br/>
        <form>
          <input 
            ...
            type="email" 
            placeholder="Email"/>
          { page && !emailValid && <p className="text-danger">Email is invalid/blank</p> }
          <input 
...
/>
<button type="button" onClick={togglePasswordVisibility} className="password-eye-button">
  {isPasswordVisible ? <FaEyeSlash /> : <FaEye />}
</button>

          { page && !passwordValid && <p className="text-danger">Password is invalid/blank</p>}
        ...
        <>
          <input 
            ...
            onBlur={validatePasswords} // Validate when the user leaves the confirm password field
          />
          {!passwordValid && <p className="text-danger">Passwords don't match</p>}
        </>
      )}
