    ...
    return(
      <div className="home-banner">
        <div className="our-story">
          <h1 className="our-story-card-title" data-uia="hero-title megh-heading">Unlimited movies, TV shows and more With MEGH'S NETFLIX..</h1><br/>
          <h2 className="our-story-card-subtitle" data-uia="our-story-card-subtitle">Watch anywhere. Cancel anytime.</h2><br/>
